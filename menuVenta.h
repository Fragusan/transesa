...
void nuevaVenta(){
    	...
    	do{
    		...
    		if (entrada.size() == 1 && isdigit(entrada[0])) {
                        ...
                        errorMsj(28,20,70,22, "Entrada no válida. Intente nuevamente.", false, 00 );
                        continue;
                    }
                    ...
                    switch (opc) {
                    			...
                    			case 0:
                    				errorMsj(15,20,84,22, "Está operación finaliza el programa. Presione enter para proseguir.", false, 00 );
                                ...
                                case 2:
		                         	//principal();
		                         	errorMsj(28,20,70,22, "Presione ENTER para confirmar.", false, 00 );
		                         	opc=0;
									continue;
                                	break;
...
void modificarVenta(){
		...
		do{
			cartelLogoEmpresa();
    		textoCentro("MENU MODIFICAR VENTA|TICKET",11);
    		textoCentro("************************",12);
    		alternarLocale();
    		hiddenCur();
    		textoCentro("Usa el teclado númerico para seleccionar una de las opciones", 14);
    		gotoxy(20, 16);printf("1. BUSCAR VENTA POR DNI CLIENTE");
    		gotoxy(20, 17);printf("2. BUSCAR VENTA POR ID DE VENTA");
    		gotoxy(20, 18);printf("3. BUSCAR VENTA POR FECHA VIAJE");
    		gotoxy(20, 19);
    		gotoxy(20, 20);cout << WINE << "0. VOLVER AL MENU PRINCIPAL" << BLACK;
    		gotoxy(20, 24);printf("OPCIÓN SELECCIONADA: -> ");
    		showCur();
    		alternarLocale();
    		string entrada;
            ...
            switch(opc){
            	case 0:
            		errorMsj(28,21,70,23, "Presione ENTER para confirmar.", true, 22 );
		            opc=0;
					//continue;
            	break;
            	case 1:
            		gotoxy(20, 21); cout << "Ingrezo opcion 1";
            		Sleep(2500);
            	break;
            	case 2:
            		gotoxy(20, 21); cout << "Ingrezo opcion 2";
            		Sleep(2500);
            	break;
            	case 3:
            		gotoxy(20, 21); cout << "Ingrezo opcion 3";
            		Sleep(2500);
            	break;
            	default:
            		cout << "Opción inválida, por favor intente de nuevo.\n";
